...
public class GlobalConstant {
	...
	public static final String ROOT_PREFIX = "jemmy";

	public static final int EXCEPTION_CAUSE_MAX_LENGTH = 2048;
	public static final int EXCEPTION_MESSAGE_MAX_LENGTH = 2048;

	public static final String ZK_REGISTRY_SERVICE_ROOT_PATH = "/jemmy/registry/service";
	public static final String ZK_REGISTRY_ID_ROOT_PATH = "/jemmy/registry/id";
	public static final String ZK_REGISTRY_PRODUCER_ROOT_PATH = "/jemmy/registry/producer";
	public static final String ZK_REGISTRY_CONSUMER_ROOT_PATH = "/jemmy/registry/consumer";
	public static final String ZK_REGISTRY_SEQ = "/jemmy/seq";
	...
	public static final class Sys {
		 ...
		 */
		public static final String DEFAULT_FILE_PATH = "jemmy/file/";
