 ...
 * @author Jemmy
 */
public class UPCEBuilder extends AbstractCodeBuilder<UPCEBuilder>{


    public UPCEBuilder(DefaultConfiguration parentCfg) {
        super(parentCfg,CodeTypeEnum.UPCE);
        parentCfg.addChild(cfg);
    }


    public UPCEBuilder checkSum(CheckSumModeEnum checkSum){
        if(null==checkSum){
