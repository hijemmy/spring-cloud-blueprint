...
public class TpcMqTagController extends BaseController {
	...
	public MvcResult<PageInfo<TpcMqTagVo>> queryTagListWithPage(@ApiParam(name = "tag", value = "角色信息") @RequestBody TpcMqTag tpcMqTag) {
	...
	@LogAnnotation
	public MvcResult modifyProducerStatusById(@ApiParam(value = "修改tag状态") @RequestBody UpdateStatusDto updateStatusDto) {
	...
	@LogAnnotation
	public MvcResult deleteTagById(@ApiParam(value = "Tag ID") @PathVariable Long id) {
