...
-- ----------------------------
INSERT INTO `tpc_mq_consumer` VALUES ('1', '1', 'service-user', 'CID_UAC', '用户中心', '20', '', '超级管理员', '1', '2018-01-20 11:17:10', '超级管理员', '1', '2018-02-02 23:37:26');
INSERT INTO `tpc_mq_consumer` VALUES ('2', '1', 'service-product', 'CID_MDC', '库存中心', '10', '', '超级管理员', '1', '2018-01-20 11:17:10', '超级管理员', '1', '2018-02-02 23:37:39');
INSERT INTO `tpc_mq_consumer` VALUES ('3', '1', 'service-opc', 'CID_OPC', '对接中心', '10', '', '超级管理员', '1', '2018-01-20 11:17:10', '超级管理员', '1', '2018-02-02 23:30:41');
...
-- ----------------------------
INSERT INTO `tpc_mq_producer` VALUES ('1', '1', 'service-user', 'PID_UAC', '用户中心', '', '10', '', '超级管理员', '1', '2018-01-20 11:17:10', '超级管理员', '1', '2018-02-02 23:27:33');
INSERT INTO `tpc_mq_producer` VALUES ('2', '1', 'service-product', 'PID_MDC', '库存中心', '', '10', '', '超级管理员', '1', '2018-01-20 11:17:10', '超级管理员', '1', '2018-01-21 12:55:04');
INSERT INTO `tpc_mq_producer` VALUES ('3', '1', 'service-opc', 'PID_OPC', '对接中心', '', '20', '', '超级管理员', '1', '2018-01-20 11:17:10', '超级管理员1', '1', '2018-01-20 11:17:10');
INSERT INTO `tpc_mq_producer` VALUES ('4', '1', 'service-tpc', 'PID_TPC', '任务中心', '', '10', '', '超级管理员', '1', '2018-01-20 11:17:10', '超级管理员1', '1', '2018-01-20 11:17:10');
...
-- ----------------------------
INSERT INTO `tpc_mq_publish` VALUES ('1', '1');
INSERT INTO `tpc_mq_publish` VALUES ('1', '2');
...
-- ----------------------------
INSERT INTO `tpc_mq_subscribe` VALUES ('1', '4', 'CID_OPC', '1', 'SEND_SMS_TOPIC');
INSERT INTO `tpc_mq_subscribe` VALUES ('2', '4', 'CID_OPC', '2', 'SEND_EMAIL_TOPIC');
INSERT INTO `tpc_mq_subscribe` VALUES ('3', '4', 'CID_OPC', '3', 'TPC_TOPIC');
INSERT INTO `tpc_mq_subscribe` VALUES ('4', '1', 'CID_UAC', '3', 'TPC_TOPIC');
INSERT INTO `tpc_mq_subscribe` VALUES ('5', '1', 'CID_OPC', '4', 'MDC_TOPIC');
...
-- ----------------------------
INSERT INTO `tpc_mq_subscribe_tag` VALUES ('1', '1');
INSERT INTO `tpc_mq_subscribe_tag` VALUES ('1', '2');
INSERT INTO `tpc_mq_subscribe_tag` VALUES ('1', '3');
INSERT INTO `tpc_mq_subscribe_tag` VALUES ('2', '4');
INSERT INTO `tpc_mq_subscribe_tag` VALUES ('2', '5');
INSERT INTO `tpc_mq_subscribe_tag` VALUES ('2', '6');
INSERT INTO `tpc_mq_subscribe_tag` VALUES ('3', '7');
INSERT INTO `tpc_mq_subscribe_tag` VALUES ('4', '8');
INSERT INTO `tpc_mq_subscribe_tag` VALUES ('5', '9');
INSERT INTO `tpc_mq_subscribe_tag` VALUES ('5', '10');
...
-- ----------------------------
INSERT INTO `tpc_mq_tag` VALUES ('1', '0', '1', 'REGISTER_USER_AUTH_CODE', '注册获取验证码', '10', '', '超级管理员', '1', '2018-01-20 11:38:39', '超级管理员', '1', '2018-02-02 23:38:59');
INSERT INTO `tpc_mq_tag` VALUES ('2', '0', '1', 'MODIFY_PASSWORD_AUTH_CODE', '修改密码获取验证码', '10', '', '超级管理员', '1', '2018-01-20 11:38:39', '超级管理员', '1', '2018-02-02 23:38:57');
INSERT INTO `tpc_mq_tag` VALUES ('3', '0', '1', 'FORGOT_PASSWORD_AUTH_CODE', '忘记密码获取验证码', '10', '', '超级管理员', '1', '2018-01-20 11:38:39', '超级管理员', '1', '2018-02-02 23:39:01');
INSERT INTO `tpc_mq_tag` VALUES ('4', '0', '2', 'ACTIVE_USER', '提示激活用户', '10', '', '超级管理员', '1', '2018-01-20 11:38:39', '超级管理员', '1', '2018-02-02 23:39:03');
INSERT INTO `tpc_mq_tag` VALUES ('5', '0', '2', 'ACTIVE_USER_SUCCESS', '激活用户成功', '10', '', '超级管理员', '1', '2018-01-20 11:38:39', '超级管理员', '1', '2018-02-02 23:39:05');
INSERT INTO `tpc_mq_tag` VALUES ('6', '0', '2', 'RESET_LOGIN_PWD', '重置密码成功', '10', '', '超级管理员', '1', '2018-01-20 11:38:39', '超级管理员', '1', '2018-02-02 23:39:07');
INSERT INTO `tpc_mq_tag` VALUES ('7', '0', '3', 'DELETE_PRODUCER_MESSAGE', '删除生产者历史消息', '10', '', '超级管理员', '1', '2018-01-20 11:38:39', '超级管理员', '1', '2018-02-02 23:39:07');
INSERT INTO `tpc_mq_tag` VALUES ('8', '0', '3', 'DELETE_CONSUMER_MESSAGE', '删除消费者历史消息', '10', '', '超级管理员', '1', '2018-01-20 11:38:39', '超级管理员', '1', '2018-02-02 23:39:07');
INSERT INTO `tpc_mq_tag` VALUES ('9', '0', '4', 'UPDATE_ATTACHMENT', '更新附件信息', '10', '', '超级管理员', '1', '2018-01-20 11:38:39', '超级管理员', '1', '2018-02-02 23:39:07');
INSERT INTO `tpc_mq_tag` VALUES ('10', '0', '4', 'DELETE_ATTACHMENT', '删除附件信息', '10', '', '超级管理员', '1', '2018-01-20 11:38:39', '超级管理员', '1', '2018-02-02 23:39:07');
...
-- ----------------------------
INSERT INTO `tpc_mq_topic` VALUES ('1', '0', null, 'SEND_SMS_TOPIC', '发送短信验证码', '10', '10', '10', '', '超级管理员', '1', '2018-01-17 23:21:42', '超级管理员', '1', '2018-02-02 23:31:32');
INSERT INTO `tpc_mq_topic` VALUES ('2', '0', null, 'SEND_EMAIL_TOPIC', '发送邮件', '10', '10', '10', '', '超级管理员', '1', '2018-01-17 23:21:42', '超级管理员', '1', '2018-01-21 10:43:11');
INSERT INTO `tpc_mq_topic` VALUES ('3', '0', null, 'TPC_TOPIC', '任务中心TOPIC', '10', '10', '10', '', '超级管理员', '1', '2018-01-17 23:21:42', '超级管理员', '1', '2018-01-21 10:43:11');
INSERT INTO `tpc_mq_topic` VALUES ('4', '0', null, 'MDC_TOPIC', '数据中心TOPIC', '10', '10', '10', '', '超级管理员', '1', '2018-01-17 23:21:42', '超级管理员', '1', '2018-01-21 10:43:11');