...
public class MallCartFeignClient extends BaseController implements OmcCartFeignApi {
	...
	public MvcResult updateCartList(@RequestBody List<CartProductVo> cartProductVoList) {
	...
	public MvcResult addProduct(@RequestParam("userId") Long userId, @RequestParam("productId") Long productId, @RequestParam(value = "count") Integer count) {
	...
	public MvcResult updateProduct(@RequestParam("userId") Long userId, @RequestParam("productId") Long productId, @RequestParam("count") Integer count) {
	...
	public MvcResult deleteProduct(@RequestParam("userId") Long userId, @RequestParam("productIds") String productIds) {
	...
	public MvcResult selectOrUnSelect(@RequestParam(name = "userId") Long userId, @RequestParam(name = "productId", required = false) Long productId, @RequestParam(name = "checked") Integer checked) {
